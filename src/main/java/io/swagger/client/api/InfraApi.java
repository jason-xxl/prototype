...
public class InfraApi {
    ...
    public InfraApi(ApiClient apiClient) {
     ...
     */
    public ExtraInfo healthGet() throws ApiException {
        ApiResponse<ExtraInfo> resp = healthGetWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ExtraInfo> healthGetWithHttpInfo() throws ApiException {
    ...
    /**
     * Server heartbeats (asynchronously)
     *
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call healthGetAsync(final ApiCallback<ExtraInfo> callback) throws ApiException {
